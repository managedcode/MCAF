...
- **<a href="https://www.linkedin.com/in/oksanakovalchuk/" target="_blank" rel="noopener">Oksana Kovalchuk</a>** — Her idea to require explicit acceptance criteria before implementation helped sharpen the MCAF workflow so agents define observable outcomes first, then write tests against those criteria.
